...
def save_extracted_data_to_txt_files(data, file_path):
    """
...
def corpus_tokenization_feature_extraction_columns_to_txt():
    ...
    if 'filename' in df.columns:
        ...
        save_extracted_data_to_txt_files(grouped_data, file_path)
    else:
        print("'filename' column does not exist in the DataFrame.")


#corpus_tokenization_feature_extraction_columns_to_txt()