...
def display_environment_file():
    ...
    if not os.path.exists(path_environment_file):
        text_dict_no_file = {
            ...
            "menu_entries_text": [
                ["",
                 "You can create a new environment file by selecting 'CONF: Update Software Paths and Preferences' in the previous menu and following the prompts to update or redefine paths to essential software and user preferences."]
            ],
        }
